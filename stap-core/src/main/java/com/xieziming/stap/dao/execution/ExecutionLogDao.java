...
public class ExecutionLogDao {
    ...
    public void add(ExecutionLog executionLog) {
        ...
        StapDbUtil.getJdbcTemplate().update(sql, new Object[]{executionLog.getExecution().getId(), executionLog.getStapLog().getId()});
    }
    ...
    public void update(ExecutionLog executionLog) {
        ...
        StapDbUtil.getJdbcTemplate().update(sql, new Object[]{executionLog.getExecution().getId(), executionLog.getStapLog().getId(), executionLog.getId()});
    }
    ...
    public ExecutionLog findById(int id) {
        ...
        return  StapDbUtil.getJdbcTemplate().queryForObject(sql, new Object[]{id}, new RowMapper<ExecutionLog>() {
            public ExecutionLog mapRow(ResultSet resultSet, int i) throws SQLException {
                ...
                executionLog.setExecution(executionDao.findById(resultSet.getInt("Execution_Id")));
